...
import git.lawpavilionprime.search_book.EbookFragmentLand;
...
public class SearchBook extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentPort = new SearchBookPortCopy();
        fragmentTransaction.replace(R.id.frag_container, fragmentPort);
