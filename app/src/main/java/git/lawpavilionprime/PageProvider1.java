 ...
 */
public class PageProvider1 extends TextPageProvider {
    ...
    public PageProvider1(Context context, int margin, int padding, int border, int borderColor, int background){
    ...
    public PageProvider1(int margin, int padding, int border, int borderColor, int background) {
    ...
    public void loadString(ArrayList<ListItems> listItem){

        String pageContent = "";

        for(int i = 0; i< listItem.size(); i++){
            String caseTitle = "<font color='#ee0000'><b>"+ listItem.get(i).getCaseTitle() + "</b></font>" ;
            String subjectMatter = "<font color='#336699'><b>"+listItem.get(i).getSubjectMatter() + "</b></font><br>";
            String body = "<b>" + listItem.get(i).getBody() + "</b><br>";
            String year = "<font color='#334561'><b>" + listItem.get(i).getYear() + "</b></font><br>";
            pageContent = pageContent  + caseTitle + year + subjectMatter + body  + "<br><br>";
        }
    ...
    public PageProvider1 (ArrayList<String> data) {
        super(data);
    }
    ...
    public void drawBitmap(Canvas c, Rect r, int index, boolean isBack) {
        ...
        Log.d("LOG LOAD", "BITMAP");
        breakText(index, r.width());
    ...
    public void breakText( int index, int width){

        ArrayList<ListItems> aPageListItem = allPagesListItem.get(index);
        ...
        for(int i =0; i< aPageListItem.size(); i++){
            ...
            Log.d("LOG REC WIDTH ", ""+width);
            Log.d("LOG REC WIDTH DP", ""+pxTodp(width));

            String caseTitle = singleListitem.getCaseTitle();
            charNum = paint.breakText(caseTitle, true, dpToPx(screenDimensionX - 60) , null);
            ...
            charNum = paint.breakText(subjectMatter, true, dpToPx(screenDimensionX * 2f), null);
