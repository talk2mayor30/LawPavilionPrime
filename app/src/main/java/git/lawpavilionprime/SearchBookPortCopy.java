...
//        falconUtility = new FalconUtility(getActivity());
        ...
        utility =  new Config(getActivity());
        ...
        if((inches < 7.0) && (config.orientation == config.ORIENTATION_PORTRAIT)) {
            ...
            bookLayout.setPadding(0, utility.dpToPx(13), utility.dpToPx(40), utility.dpToPx(40));

            padding = utility.dpToPx(40);
            ...
            layoutParams = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.MATCH_PARENT, 1);
            bookLayout.setPadding(0, utility.dpToPx(19), utility.dpToPx(55), utility.dpToPx(65));
            padding = utility.dpToPx(50);
        ...
        textPageProvider = new PageProvider1(getActivity(), margin, padding, border, borderColor, background);
        ...
        paint.setTextSize(utility.dpToPx(13));
        ...
        NumOfItemPerPage = utility.dpToPx(screenDimensionY) / multiLineHeight;
...
//                for(int i= 0; i<mTempQueryResult.size(); i++){
//                    title.add(mTempQueryResult.get(i).getTitle());
//                    subjectMatter.add(mTempQueryResult.get(i).getSubjectmatter());
//                    body.add(mTempQueryResult.get(i).getDescription());
//                    year.add("2014");
//                    issues.add(mTempQueryResult.get(i).getIssue());
//                }
...
//                            mTempQueryResult.get(position).getSubjectmatter(), mTempQueryResult.get(position).getDescription(),
//                                "2010"));
                }
