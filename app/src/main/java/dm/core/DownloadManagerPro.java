...
import dm.core.chunkWorker.Moderator;
import dm.core.enums.QueueSort;
import dm.core.enums.TaskStates;
import dm.core.mainWorker.AsyncStartDownload;
import dm.core.mainWorker.QueueModerator;
import dm.database.ChunksDataSource;
import dm.database.DatabaseHelper;
import dm.database.TasksDataSource;
import dm.database.elements.Chunk;
import dm.database.elements.Task;
import dm.report.ReportStructure;
import dm.report.exceptions.QueueDownloadInProgressException;
import dm.report.exceptions.QueueDownloadNotStartedException;
import dm.report.listener.DownloadManagerListener;
import dm.report.listener.DownloadManagerListenerModerator;
...
//        dbHelper.close();
     ...
     * @throws dm.report.exceptions.QueueDownloadNotStartedException
     */
